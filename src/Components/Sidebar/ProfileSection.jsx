...
const ProfileSection = () => {
    return (
        <div className="flex items-center justify-between p-4  bg-[#111b21]">
            <div className="flex items-center">
                <span className="ml-3 font-semibold text-xl text-white">Chats</span>
            </div>
            <div className="flex space-x-3">
                <button className="p-2 text-gray-100  rounded-full">
